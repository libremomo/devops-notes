...
## ۶- ۱. پیش‌نیازها
برای راه‌اندازی این کلاستر دست‌کم به ۵ نود احتیاج داریم. این ۵ نود می‌توانند ماشین‌های لینوکسی فیزیکی یا مجازی باشند. در این راهنما ما از ماشین‌های مجازی استفاده می‌کنیم. حداقل نیازمندی‌های سخت‌افزاری و نرم‌افزاری این ماشین‌ها در زیر آمده است:
...
---
پستگرس نسخهٔ ۱۴ به صورت پیش‌فرض روی مخازن اوبونتو وجود دارد، اما ما از نسخهٔ ۱۷ استفاده می‌کنیم. برای نصب این نسخه بایستی نخست مخزن APT خود پستگرس را به ماشین‌ها اضافه کنیم. طبق مستندات پستگرس از مسیر زیر اقدام ‌می‌کنیم:
